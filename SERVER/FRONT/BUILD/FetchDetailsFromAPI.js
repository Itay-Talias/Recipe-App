...
class FetchDetailsFromAPI {
    ...
    static FetchRecipeArrByIngredientGlutenFree(ingredient_name) {
        return __awaiter(this, void 0, void 0, function* () {
            const recipesArr = yield $.get(`./recipes/${ingredient_name}?gluten_free=True`);
            return this.parsingJSONToRecipesArr(recipesArr);
        });
    }
    static FetchRecipeArrByIngredientDaityFree(ingredient_name) {
        return __awaiter(this, void 0, void 0, function* () {
            const recipesArr = yield $.get(`./recipes/${ingredient_name}?daity_free=True`);
            return this.parsingJSONToRecipesArr(recipesArr);
        });
    }
    static FetchRecipeArrByIngredientDaityFreeAndGlutenFree(ingredient_name) {
        return __awaiter(this, void 0, void 0, function* () {
            const recipesArr = yield $.get(`./recipes/${ingredient_name}?daity_free=True&gluten_free=True`);
            return this.parsingJSONToRecipesArr(recipesArr);
        });
    }
}
